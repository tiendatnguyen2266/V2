...
*/
#define RXD2 16   // Serial2 RX (connect this to the EBYTE Tx pin)
#define TXD2 17   // Serial2 TX (connect this to the EBYTE Rx pin)

#define PIN_M0 4    // D4 on the board (possibly pin 24)
#define PIN_M1 22   // D2 on the board (possibly called pin 22)
#define PIN_AX -1   // D15 on the board (possibly called pin 21)
